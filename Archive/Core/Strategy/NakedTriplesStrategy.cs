...
public class NakedTriplesStrategy : BaseStrategy<NakedTriplesStrategy>
{
    ...
    private void FindNakedTriples(Unit unit, EliminationSolvePuzzleAction action)
    {
    ...
    private void MarkEliminations(Unit unit, Cell[] triple, int[] triple_candidates, EliminationSolvePuzzleAction action)
    {
